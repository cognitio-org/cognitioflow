...
```mermaid
flowchart TD
  A[National measure] --> B{Charge or MEQR?}
  B -->|Charge, Art 30| C[Unlawful — no justification]
  B -->|MEQR, Art 34| D{Distinctly applicable?}
  D -->|Yes| E[Art 36 grounds only]
  D -->|No| F[Art 36 plus mandatory requirements]
  E --> G{Proportionate?}
  F --> G
  G -->|No| H[Unlawful]
  G -->|Yes| I[Lawful]
